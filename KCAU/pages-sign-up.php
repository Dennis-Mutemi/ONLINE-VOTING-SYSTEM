					...
					<div class="row my-7">				
						<div class="col-12 col-md-10 col-xxl-4 d-flex mx-auto">
							<div class="card flex-fill w-100 mx-auto">
								...
								<p class="card-text">									
									<form id="main" class="mx-auto">
										...
										<div class="form-group">
											...
											<input class="form-control form-control-lg" type="password" name="retypepassword" placeholder="Retype Password" />
										</div>
										<div class="form-group">
											<label>Registration Number</label>
											<input class="form-control form-control-lg" type="text" name="registration" placeholder="Enter reg.No" />
										</div>
										...
										<label id="values">Select Your Course</label> 
											<select id="course" class="form-control form-control-lg">
												<option value="" id="course">--Select Your Course--</option>
								...
								<p class="btn btn-danger btn-sm p-1" onclick="coll()">Cancel</p>
                                <p class="btn btn-secondary btn-sm ms-4 p-1" onclick="collectdata()">Create</p>
								</div>
							</div>
						</div>
					</div>
